...
class OpenplusMigrateSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form[ConfigUtil::HARVESTER_API_URL_SETTING] = array(
      ...
      '#description' => $this->t('Ex. /api/v1/export'),
      '#default_value' => ConfigUtil::GetHarvesterApiUrl(),
      '#required' => TRUE,
    );

    $form[ConfigUtil::HARVESTER_USER_SETTING] = array(
      '#type' => 'textfield',
      '#title' => $this->t('User'),
      '#default_value' => ConfigUtil::GetHarvesterUser(),
      '#required' => TRUE,
    );

    $form[ConfigUtil::HARVESTER_PASSWORD_SETTING] = array(
      '#type' => 'password',
      '#title' => $this->t('Password'),
      '#attributes' => ['value' => ConfigUtil::GetHarvesterPass()],
      '#required' => TRUE,
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Set the submitted configuration setting
      ...
      ->set(ConfigUtil::HARVESTER_USER_SETTING, $form_state->getValue(ConfigUtil::HARVESTER_USER_SETTING))
      ->set(ConfigUtil::HARVESTER_PASSWORD_SETTING, $form_state->getValue(ConfigUtil::HARVESTER_PASSWORD_SETTING))
      ->save();
