 ...
 * @FieldFormatter(
 *   id = "html_link",
 *   label = @Translation("Link with HTML"),
 *   field_types = {
 *     "link"
 *   }
 * )
 */
class HtmlLinkFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      if (!empty($settings['url_only']) && !empty($settings['url_plain'])) {
        ...
        $element[$delta] = [
          '#type' => 'link',
          '#title' => Markup::create($link_title),
