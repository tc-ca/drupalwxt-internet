 ...
 *
 */
if (extension_loaded('redis') && filter_var(getenv('REDIS_ENABLED'), FILTER_VALIDATE_BOOLEAN)) {
  ...
  /** Optional prefix for cache entries */  $settings['cache_prefix'] = 'drupal_';

  /** @see: https://pantheon.io/docs/redis/ */  // Always set the fast backend for bootstrap, discover and config, otherwise
  // this gets lost when redis is enabled.
  $settings['cache']['bins']['bootstrap'] = 'cache.backend.chainedfast';
  $settings['cache']['bins']['discovery'] = 'cache.backend.chainedfast';
  $settings['cache']['bins']['config'] = 'cache.backend.chainedfast';

  /** @see: https://github.com/md-systems/redis */  // Use for all bins otherwise specified.
  $settings['cache']['default'] = 'cache.backend.redis';
