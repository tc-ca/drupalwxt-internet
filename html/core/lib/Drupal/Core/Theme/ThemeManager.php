...
class ThemeManager implements ThemeManagerInterface {
  ...
  public function render($hook, array $variables) {
    ...
    // Append the original theme hook if it is a theme suggestion and not
    // already in the suggestions array.
    if (strpos($original_hook, '__') !== FALSE && !in_array($original_hook, $suggestions)) {
      $suggestions[] = $original_hook;
    }
