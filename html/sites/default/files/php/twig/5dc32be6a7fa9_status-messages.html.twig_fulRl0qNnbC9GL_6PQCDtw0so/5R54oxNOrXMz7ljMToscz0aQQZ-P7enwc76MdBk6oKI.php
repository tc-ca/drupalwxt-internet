...
/* themes/custom/wxt_bootstrap/templates/system/status-messages.html.twig */
class __TwigTemplate_6b268e2af9cb9ad5fcc1af2a815a4d802b21d739023efe085ce6b9baf0a8e1fc extends \Twig\Template
{
...
($context["status_classes"] ?? null), $context["type"], [], "array"))), 2 => "alert-dismissible"];
            ...
            // line 66
            echo "    <div";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["attributes"] ?? null), "setAttribute", [0 => "class", 1 => ($context["classes"] ?? null)], "method"), "addClass", [0 => ($context["message_classes"] ?? null), 1 => "mrgn-tp-md", 2 => "mrgn-bttm-md"], "method"), "setAttribute", [0 => "role", 1 => $this->getAttribute(($context["status_roles"] ?? null), $context["type"], [], "array")], "method"), "setAttribute", [0 => "aria-label", 1 => $this->getAttribute(($context["status_headings"] ?? null), $context["type"], [], "array")], "method")), "html", null, true);
            echo " tabindex=\"0\">
  ...
  ";
    ...
    {
        return "themes/custom/wxt_bootstrap/templates/system/status-messages.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/wxt_bootstrap/templates/system/status-messages.html.twig", "/Users/joelb/Sites/wxt83001/html/themes/custom/wxt_bootstrap/templates/system/status-messages.html.twig");
    }
}
